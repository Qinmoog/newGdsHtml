					...
					success : function (data){
						if(data.result=='-1'){
							...
							synchronizing = 'false';
								...
								cusmot_alert_fun('You have just encountered a technical failure ('+data.errCode+'). Please report it to our customer service representative if possible, thank you.');
						}
					}
				});
			}
